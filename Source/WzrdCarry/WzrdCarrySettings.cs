...
namespace WzrdCarry
{
	...
	public class WzrdCarrySettings : ModSettings
	{
		...
		{
			string text = carryCapacity.ToString();
			string text2 = transportPodCapacity.ToString();
            Listing_Standard listing_Standard = new Listing_Standard(GameFont.Small)
            {
                ColumnWidth = inRect.width
            };
            listing_Standard.Begin(inRect);
			listing_Standard.TextFieldNumericLabeled("Pawn Carrying Capacity", ref carryCapacity, ref text, 0f, 1E+09f);
			listing_Standard.TextFieldNumericLabeled("Transport Pod Capacity", ref transportPodCapacity, ref text2, 0f, 1E+09f);
